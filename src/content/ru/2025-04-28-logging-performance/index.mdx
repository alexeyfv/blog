---
title: 'CA2254, логирование в C# и проблемы с производительностью'
description: 'Разбираем CA2254, почему логирование может ухудшать производительность и как помогает LoggerMessageAttribute.'
pubDate: 'Apr 28 2025'
