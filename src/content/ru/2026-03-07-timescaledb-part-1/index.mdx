...
Как видно из [результатов](https://github.com/alexeyfv/DotNetBenchmarks/blob/main/TimescaleDB/BenchmarkDotNet.Artifacts/results/Benchmark.Benchmark-report-github.md), производительность TimescaleDB на 15% - 28% лучше при низкой кардинальности (до около 10 000 уникальных ресурсов, или около 100 строк данных на ресурс).
