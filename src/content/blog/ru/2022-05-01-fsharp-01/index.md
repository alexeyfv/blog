...
description: 'Введение в функциональное программирование на примере реализации последовательности Фибоначчи на F# и C#, сравнение подходов и преимущества функционального стиля'
pubDate: 'May 01 2022'
heroImage: 'cover.png'
