...
description: 'A performance comparison of different EF mapping strategies in SQL Server'
pubDate: 'Feb 25 2023'
heroImage: 'cover.png'
...
| -------------------------------------------- | -------------------------------------------- | -------------------------------------------- | ---------------------------------------------------------- |
| <Image src={diagramTph} alt="TPH diagram" /> | <Image src={diagramTpc} alt="TPC diagram" /> | <Image src={diagramTpt} alt="TPT diagram" /> | <Image src={diagramTphJson} alt="TPH with JSON diagram" /> |
...
<Image
  ...
  alt="Execution time for inserting data"
/>
...
<Image
  ...
  alt="Execution time for selecting data"
/>
<strong style="text-align: center;">
...
<Image
  ...
  alt="Dependence of inserting time on entities and properties count"
/>
<strong style="text-align: center;">
  Figure 3 - Dependence of inserting time on the number of entities and
  the number of properties
</strong>

<Image
  src={tphTphJsonInsertRatioEntities}
  alt="TPH vs TPH with JSON insert ratio by entities"
/>
<strong style="text-align: center;">
  Figure 4 - Ratio of `TPH` execution time to `TPH with JSON` execution
  time for inserting data
</strong>


<Image
  src={tphTphJsonInsertRatioProps}
  alt="TPH vs TPH with JSON insert ratio by properties"
/>
<strong style="text-align: center;">
  Figure 5 - Ratio of `TPH` execution time to `TPH with JSON` execution
  time for inserting data
</strong>
...
<Image
  ...
  alt="Dependence of selecting time on entities and properties count"
/>
<strong style="text-align: center;">
  Figure 6 - Dependence of selecting time on the number of entities and
  the number of properties
</strong>

<Image
  src={tphTphJsonSelectRatioEntities}
  alt="TPH vs TPH with JSON select ratio by entities"
/>
<strong style="text-align: center;">
  Figure 7 - Ratio of `TPH` execution time to `TPH with JSON` execution
  time for selecting data
</strong>

<Image
  src={tphTphJsonSelectRatioProps}
  alt="TPH vs TPH with JSON select ratio by properties"
/>
<strong style="text-align: center;">
  Figure 8 - Ratio of `TPH` execution time to `TPH with JSON` execution
  time for selecting data
</strong>
