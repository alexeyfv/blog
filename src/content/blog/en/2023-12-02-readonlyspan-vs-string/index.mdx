...
description: 'A performance comparison between ReadOnlySpan<T> and string operations in C#'
pubDate: 'Dec 02 2023'
heroImage: 'cover.png'
tags: ['C#', 'Performance']
---
...
<Image src={image1} alt="Performance comparison of ReadOnlySpan execution" />
...
<Image
  src={image2}
  alt="Performance comparison of ReadOnlySpan with allocation execution"
/>
<strong style="text-align: center;">
ReadOnlySpan execution ratio
</strong>
